...
print()
print('B1_Cellpose_target:', B1_SaveRawScanpy_target)
print('B1_target:', B1_target)
print('B2_SaveRawScanpy_target:', B2_Filtering_target)
print('B2_target:', B2_target)
print('B3_Annotation_target:', B3_PostprocQC_target)
...
rule A1:
    ...
    run:
        ...
        _1_._A1_Cellpose(name, input, output, hashes, commit)
...
rule A3:
    ...
    run:
        name=ids[wildcards.exp_id]
        print('NAME HERE', name)
        _2_.A3_Preporcessing(name, input, output, hashes, commit)
...
rule A4:
    ...
    output:
        A4_target
    run:
        _2_.QC_1_postsegqc(input, output)
